...
Hệ thống hỗ trợ sử dụng nhiều API key để tăng khả năng xoay proxy. Cấu hình trong file `.env`:
...
Mỗi proxy được tự động đổi theo một khoảng thời gian ngẫu nhiên (mặc định 60-120 giây) để tránh bị chặn.
